// Package log is the logging library
package log
...
// FormatUTCRFC3339 returns the given time in UTC with RFC3999Nano format.
...
// FormatUTCKitchen returns the given time in UTC with Kitchen format.
func FormatUTCKitchen(t time.Time) string {
	return t.UTC().Format(time.Kitchen)
}

// FormatKitchen returns the given time in UTC with Kitchen format.
